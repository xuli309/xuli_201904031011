...
export class UcenterComponent implements OnInit {
  ...
  avatar = 'http://kkbconsole2.kaikeba.com/statics/images/avatar_100_100.png'; // 用户头像url
  ...
  onUploadOutput(output: UploadOutput) { // UploadOutput 封装上传的属性
